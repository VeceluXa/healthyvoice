package com.danilovfa.feature.cut.composable
...
import com.danilovfa.feature.cut.store.CutStoreExecutor.Companion.MIN_CUT_SIZE_MILLIS
...
fun CutGraph(
    ...
    var endOffsetPx by remember {
        mutableStateOf(graphWidthPx / durationMillis * endOffsetMillis)
    }
