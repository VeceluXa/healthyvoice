package com.danilovfa.feature.cut.store
...
import com.danilovfa.feature.cut.store.CutStoreFactory.Action
import com.danilovfa.feature.cut.store.CutStoreFactory.Msg
...
internal class CutStoreExecutor : KoinComponent,
    ...
    private fun loadRecording(data: AudioData) {
        scope.launch {
            ...
            Timber.tag(LOG_TAG).d("Amplitudes: ${amplitudes.joinToString()}")
