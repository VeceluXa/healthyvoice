...
import com.danilovfa.common.core.domain.lce.Lce.Content
import com.danilovfa.common.core.domain.lce.Lce.Error
import com.danilovfa.common.core.domain.lce.Lce.Loading
...
sealed class Lce<out C> : LceState {
    ...
    data object Loading : Lce<Nothing>(), LceState.Loading
