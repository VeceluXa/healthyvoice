    ...
    AnimatedVisibility(showHint) {
        Column {
            ...
            val hintColor = if (isError) {
                ...
                AppTheme.colors.primaryDisabled
            }
            Text(
                text = hintText,
...
private fun TextFieldPreview(@PreviewParameter(ThemePreviewParameter::class) isDarkMode: Boolean) {
    AppTheme(isDarkMode) {
        Column(
            Modifier
                .padding(8.dp)
