...
interface SnackbarStyle {
    ...
    object Image : SnackbarStyle {
        override val icon: Painter
            @Composable get() = AppIcon.Done
    }

    object TryAgain : SnackbarStyle {
...
private fun StyledSnackbar(snackbarData: SnackbarData) {
    if (snackbarData is StyledSnackbarData) {
        MaterialSnackbar(snackbarData = snackbarData)
    } else {
