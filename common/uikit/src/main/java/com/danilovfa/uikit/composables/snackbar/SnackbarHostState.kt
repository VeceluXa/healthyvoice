...
@Stable
class SnackbarHostState(val delegate: MaterialSnackbarHostState) {
    ...
    suspend fun showSnackbar(
        ...
        return mutex.withLock {
            ...
            try {
                snackbarAlignment = if (snackbarStyle.isBottom) SnackbarAlignment.BOTTOM else SnackbarAlignment.TOP
...
@Composable
internal fun rememberSnackbarHostState(snackbarHostState: MaterialSnackbarHostState): SnackbarHostState {
